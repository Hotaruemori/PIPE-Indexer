...
const LoginPage = () => {
  ...
  return (
    ...
    <form className="w-1/4 bg-sky-200 p-4 items-center font-semibold font-sans mx-auto justify-center mt-40 flex flex-col shadow-lg shadow-blue-400" onSubmit={formik.handleSubmit}>
        ...
        <span className="text-center w-3/4 bg-none text-4xl text-indigo-600 border-b border-slate-400 py-6 px-10 mt-3">Login</span>
        <div className="grid grid-cols-2 h-8 w-full text-lg overflow-none mt-10 ">
            <span className="text-indigo-600 text-right px-5 mr-6 py-2 text-xl">Username:</span>
        ...
        <div className="grid grid-cols-2 h-8 w-full text-lg overflow-none mt-10">
            <span className="text-indigo-600 text-right px-5 mr-6 py-2 text-xl">Password:</span>
