  ...
  return (
    ...
    <div className="dark:bg-slate-700">
        <form className="w-[500px] bg-sky-500 dark:bg-sky-200 p-4 items-center font-semibold font-sans mx-auto justify-center mt-40 flex flex-col shadow-lg shadow-blue-400" onSubmit={formik.handleSubmit}>
            <DarkModeSwitcher />
            <span className="text-center w-3/4 bg-none text-4xl text-white dark:text-indigo-600 border-b border-white dark:border-indigo-600 py-6 px-10 mt-3">User Register</span>
            <div className="grid grid-cols-2 h-8 w-full text-lg overflow-none mt-10 ">
                <span className="text-white dark:text-indigo-600 text-right px-5 py-2 text-xl">Username:</span>
            ...
            <div className="grid grid-cols-2 h-8 w-full text-lg overflow-none mt-10">
                <span className="text-white dark:text-indigo-600 text-right px-5 py-2 text-xl">Password:</span>
            ...
            <div className="grid grid-cols-2 h-8 w-full text-lg overflow-none mt-10">
                <span className="text-white dark:text-indigo-600 text-right py-2 px-5 text-xl">Confirm Password:</span>
